...
def test_dockerfile_installs_pinned_pi_packages():
    ...
    assert "ARG PI_CODING_AGENT_VERSION=0.80.6" in dockerfile
    assert "ARG PI_WEB_ACCESS_VERSION=0.13.0" in dockerfile
